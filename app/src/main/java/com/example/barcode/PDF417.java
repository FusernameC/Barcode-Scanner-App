    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        copyBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(dataEdt3.getText().toString())) {
                    Toast.makeText(PDF417.this, "No text to copy", Toast.LENGTH_SHORT).show();
                } else {
                    File filename;
                    try {
                        ...
                        Toast.makeText(PDF417.this, "File is Saved in  " + filename, Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
